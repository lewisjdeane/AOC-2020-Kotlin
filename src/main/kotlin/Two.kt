...
private fun a() = parse().count { it.isValidA }

private fun b() = parse().count { it.isValidB }
...
private fun parse() = input.lines().map { PasswordValidationRequest.fromRaw(it) }

private const val input = """2-7 p: pbhhzpmppb
3-6 h: jkhnhwhx
5-6 x: xxxxxmxf
