...
private fun a() = calculateCount(::predicateA)
private fun b() = calculateCount(::predicateB)

private fun calculateCount(predicate: (List<String>, Char) -> Boolean): Int {
    return groups.sumBy { group -> alphabet.count { letter -> predicate(group, letter) } }
}
